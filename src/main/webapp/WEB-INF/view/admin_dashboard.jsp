                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="white-box">
                            <div class="d-md-flex mb-3">
                                <h3 class="box-title mb-0" style="color: navy;">Admin List</h3>
                                    ...
                                    <tbody  style="overflow: scroll">
                                       <c:forEach var="list" items="${userlist}">
                                        <tr>
                                            ...
                                            <td class="border-top-0">${list.getphone_no()}</td>
                                            <td class="border-top-0">${list.getemail()}</td>
                                            <td class="border-top-0"><a class="btn btn-danger" href="deleteadmin?adminid=${list.getadmin_id()}">Delete</a></td>
