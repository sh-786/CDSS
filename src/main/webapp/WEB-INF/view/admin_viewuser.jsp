            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-4 col-sm-4 col-xs-12">
                        <h2 class="page-title text-uppercase font-medium font-18">Welcome to Admin Dashboard</h2>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="white-box">
                            <div class="d-md-flex mb-3">
                                <h3 class="box-title mb-0" style="color: navy;">User List</h3>
                                
                            </div>
                            <div class="table-responsive" style="overflow-y: scroll; height: 20em;">
                                <table style="overflow: scroll;" class="table no-wrap">
                                    ...
                                    <tbody  style="overflow-x: auto">
                                      <c:forEach var="list" items="${viwerlist}">
                                        <tr>
                                            
                                            <td class="border-top-0">${list.getfirst_name()}</td>
                                            <td class="border-top-0">${list.getlast_name()}</td>
                                            <td class="border-top-0">${list.getcompany_name()}</td>
                                             <td class="border-top-0">${list.getdepartment()}</td>
                                            <td class="border-top-0">${list.getemail()}</td>
                                            <td class="border-top-0"><a class="btn btn-danger" href="deleteviewer?viewerid=${list.getviewer_id()}">Delete</a></td>
